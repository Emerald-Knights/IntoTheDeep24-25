...
//        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "rightFront");
        ...
        motors = Arrays.asList(Robot.getInstance().leftFront, Robot.getInstance().leftBack, Robot.getInstance().rightBack, Robot.getInstance().rightFront);
        leftMotors = Arrays.asList(Robot.getInstance().leftFront, Robot.getInstance().leftBack);
        rightMotors = Arrays.asList(Robot.getInstance().rightFront, Robot.getInstance().rightBack);
